      ...
      <div className="relative flex h-full flex-col">
            ...
            <div className="flex items-center gap-3">
              ...
              {isOpen && (
                <div>
                  ...
                  <p className="text-xs text-white/55">Modern Control Center</p>
                </div>
              )}
            </div>
            <button
        ...
        <div className="border-t border-white/10 p-4">
          <div className="mb-3 rounded-2xl border border-white/10 bg-white/5 p-3 text-xs text-white/70">
            {isOpen ? (
              <>
                <p className="font-semibold text-white">Workspace secure</p>
                <p>All sessions are protected with 256-bit encryption.</p>
              </>
            ) : (
              <p className="text-center text-white/60">Secure</p>
            )}
          </div>
          <button
